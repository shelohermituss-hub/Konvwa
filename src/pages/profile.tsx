...
import IconPersonnel       from 'flat-color-icons/svg/businessman.svg'
import IconAdresse         from 'flat-color-icons/svg/home.svg'
import IconNotif           from 'flat-color-icons/svg/news.svg'
import IconMdp             from 'flat-color-icons/svg/key.svg'
import IconConfidentialite from 'flat-color-icons/svg/privacy.svg'
import IconParametres      from 'flat-color-icons/svg/settings.svg'
import IconSupport         from 'flat-color-icons/svg/customer_support.svg'
import IconDeconnexion     from 'flat-color-icons/svg/leave.svg'
